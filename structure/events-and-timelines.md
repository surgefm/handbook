...
每个时间线都会有若干个话题。话题，即标签（tag），是一个事件相关的固有属性。例如「[上海张江强行征用人才公寓作隔离点引发警民冲突](https://langchao.org/@RKives/184-shang-hai-zhang-jiang-qiang-hang-zheng-yong-ren/)」事件，即有「上海」「COVID」「警民冲突」四个话题。
